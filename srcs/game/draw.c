...
/*   Updated: 2021/05/06 12:40:31 by ketaouki         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	if(s->raycast.side == 0)
		s->t.wall_x = s->player.position_y + s->raycast.wall_height * s->raycast.raydir_y;
	else
		s->t.wall_x = s->player.position_x + s->raycast.wall_height * s->raycast.raydir_x;
